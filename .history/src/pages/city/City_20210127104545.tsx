...
const City = (props: any) => {
  ...
  const writeWeatherToStorage = () => {
    ...
    localStorage.setItem("cityWeather", JSON.stringify(props.weather));
  };
  ...
  return (
    <Card className="City">
      {props.weather && (<Heading name={props.weather.name}></Heading>
      <ul>
        <li>
          <span>
            <b>city:</b>
...
const mapDispatchToProps = (dispatch: Dispatch) => {
  return {
    setWeather: (payload: string) => dispatch(setCityWeather(payload)),
  };
};
