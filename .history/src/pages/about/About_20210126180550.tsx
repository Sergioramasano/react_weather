  ...
  return (
    <section className="about">
      ...
      <p>
        ...
        deleniti incidunt excepturi sequi veniam neque, rerum, recusandae itaque
        magni! Architecto praesentium illo ipsum voluptatibus unde libero iure
        veritatis, voluptas, voluptate eos eum delectus temporibus possimus!
        Quasi totam provident, voluptates laudantium libero qui vitae. Fugit
        cupiditate accusamus accusantium nemo, repudiandae quasi dolores
        voluptates hic, deleniti labore earum sapiente nisi! Pariatur, rerum.
      </p>
